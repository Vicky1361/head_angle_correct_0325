...
train_mask_dir = '/mnt/data1/wx/data/train_npy/masks'
val_img_dir = '/mnt/data1/wx/data/val_npy/images'
val_mask_dir = '/mnt/data1/wx/data/val_npy/masks'
model_save_dir = '/mnt/data3/brain_angle_correction/model_save/no_rotate'
...
for epoch in range(400):
    train_loader = data.DataLoader(dataset_3d.my_dataset_seg(train_img_paths, train_mask_paths, 24, is_crop=False, is_rotate=False), num_workers=4, drop_last=True, batch_size=batch_size, shuffle=True)
    train_loss_sum = 0
