...
if __name__ == '__main__':
	...
	modelPath = '/mnt/data3/brain_angle_correction/model_save/no_rotate_val_rotate/unet_modify_group.pkl' #'/mnt/data1/wx/graduation_project/model/unet_modify_group.pkl' # '/mnt/data3/brain_angle_correction/model_save/no_rotate/unet_modify_group.pkl' # 模型文件路径 '/mnt/data1/wx/result_project/model/unet_modify_group.pkl'
	dstDir    = '/mnt/data3/brain_angle_correction/result_no_rotate' # 完成处理之后，用于保存结果的文件夹
	normalGTPath  = '/mnt/data3/brain_angle_correction/GT_2_26.npy'
	...
	for imagePath in imagePaths:
		...
		# if showPlane:
		# 	# 将平面画出来方便查看
		# 	drawPlane(image, normalZYX, b, 9999)
		...
		# saveMhd(image, origin, newSpacingXYZ, imageSavePath)
		# saveMhd(rotatedImage, origin, newSpacingXYZ, imageSavePath.replace('.mhd', '_rotated.mhd'))
